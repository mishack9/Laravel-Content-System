...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{route('admin.createPost')}}" class="brand-link text-center">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="{{route('admin.createPost')}}" class="d-block">{{ Auth::user()->role }}</a>
                    </div>
                </div>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{route('admin.mediaPost')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Media Posts</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('admin.viewPost')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>View Posts</p>
                                    </a>
                                </li>
                                ...
                                @if(Auth::user()->role === 'admin')
                                <li class="nav-item">
                                    <a href="{{route('admin.viewEditorPost')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>View Editors Posts</p>
                                    </a>
                                </li>
                                @endif
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route('admin.manageCatergory')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Catergories</p>
                                    </a>
                                </li>
