                        ...
                        <div class="container-fluid">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Create Catergory For Content Post Here</h3>
                                </div>
            
                                <form action="{{route('admin.storeCatergory')}}" method="post">
                                    @csrf
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Catergory Title</label>
                                            <input type="text" class="form-control" name = "name" id="exampleInputEmail1"
                                                placeholder="Enter Catergory Name" style="@error('name')
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $post)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('admin.edithCatergory', $post->id) }}" class="btn btn-success"><i
                                                    class="fas fa-pen"></i></a></td>
                                        <td><a href="{{ route('admin.deleteCatergory', $post['id']) }}"
