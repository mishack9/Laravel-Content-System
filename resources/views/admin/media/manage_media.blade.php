                            ...
                            <div class="container-fluid">
                                ...
                                <div class="card card-primary mb-5">
                                    <div class="card-header">
                                        <h3 class="card-title">Create Media Post Here</h3>
                                        <div class="card-tools"><a href="{{route('admin.viewMediaPost')}}" class="btn btn-info">View_Media_Posts</a></div>
                                    </div>

                                    <form action="{{ route('admin.storeMediaPost') }}" method="post"
